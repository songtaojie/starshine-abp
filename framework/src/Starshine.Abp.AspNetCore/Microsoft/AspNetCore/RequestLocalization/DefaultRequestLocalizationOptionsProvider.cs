...
public class DefaultRequestLocalizationOptionsProvider : IRequestLocalizationOptionsProvider, ISingletonDependency
{
                ...
                if (_requestLocalizationOptions == null)
                {
                    using (var serviceScope = _serviceProviderFactory.CreateScope())
                    {
                        ...
                        foreach (var configurator in serviceScope.ServiceProvider
                            .GetRequiredService<IOptions<StarshineRequestLocalizationOptions>>()
